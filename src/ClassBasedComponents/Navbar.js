...
// Define a class-based component called 'Navbar'
class Navbar extends React.Component {
  ...
  // Render method to define how the component should be displayed
  render() {
    return (
      <>
          ...
          <div className="container-fluid">
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <select className="form-select bg-dark text-light" onChange={this.handleCountryChange}>
